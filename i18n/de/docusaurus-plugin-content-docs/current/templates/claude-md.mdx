...
Eine CLAUDE.md, die lang, wunschdenkerisch oder veraltet ist, *schadet* — Claude folgt ihr wörtlich. Beschreibe, wie das Projekt **tatsächlich** funktioniert, und kürze rücksichtslos. Details auf der [CLAUDE.md-Seite](/docs/claude-code/claude-md).
:::
...
- **Nutze `@imports`**, um vorhandene Dokumente einzubinden, statt sie zu duplizieren (siehe die [CLAUDE.md-Referenz](/docs/claude-code/claude-md)).
- **Überprüfe sie monatlich.** Veraltete Anweisungen sind schlimmer als gar keine.

## Verwandtes

- Die vollständige Anleitung → [CLAUDE.md & Memory-Dateien](/docs/claude-code/claude-md)
- Weitere Startvorlagen → [SKILL.md-Vorlagen](/docs/templates/skills), [Hooks- & Settings-Rezepte](/docs/templates/hooks-settings)
