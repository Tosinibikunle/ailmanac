...
Длинный, мечтательный или устаревший CLAUDE.md *вредит* — Claude следует ему буквально. Описывайте, как проект работает **на самом деле**, и безжалостно сокращайте. Подробности — на [странице CLAUDE.md](/docs/claude-code/claude-md).
:::
...
- **Используйте `@imports`**, чтобы подтягивать существующую документацию вместо её дублирования (см. [справочник по CLAUDE.md](/docs/claude-code/claude-md)).
- **Пересматривайте его ежемесячно.** Устаревшие инструкции хуже, чем их отсутствие.

## Связанное

- Полное руководство → [CLAUDE.md и файлы памяти](/docs/claude-code/claude-md)
- Больше стартовых шаблонов → [Шаблоны SKILL.md](/docs/templates/skills), [рецепты хуков и настроек](/docs/templates/hooks-settings)
