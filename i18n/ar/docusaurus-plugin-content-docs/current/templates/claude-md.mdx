...
الـ CLAUDE.md الطويل أو الطموح أو القديم *يضرّ* — إذ يتبعه Claude حرفياً. صِف كيف يعمل المشروع **فعلياً**، وقلّمه بلا رحمة. التفاصيل في [صفحة CLAUDE.md](/docs/claude-code/claude-md).
:::
...
- **استخدم `@imports`** لجلب المستندات الموجودة بدلاً من تكرارها (راجع [مرجع CLAUDE.md](/docs/claude-code/claude-md)).
- **راجعه شهرياً.** التعليمات القديمة أسوأ من عدم وجودها.

## ذات صلة

- الدليل الكامل لكيفية العمل ← [CLAUDE.md وملفات الذاكرة](/docs/claude-code/claude-md)
- المزيد من القوالب ← [قوالب SKILL.md](/docs/templates/skills)، [وصفات الخطافات والإعدادات](/docs/templates/hooks-settings)
