...
एक ऐसी CLAUDE.md जो लंबी, आकांक्षापूर्ण या पुरानी हो, वह *नुकसान* पहुँचाती है — Claude इसे अक्षरशः फॉलो करता है। बताएँ कि प्रोजेक्ट **वास्तव में** कैसे काम करता है, और निर्ममता से छाँटें। विवरण [CLAUDE.md पेज](/docs/claude-code/claude-md) पर।
:::
...
- **`@imports` का उपयोग करें** मौजूदा दस्तावेज़ों को डुप्लिकेट करने के बजाय उन्हें खींचने के लिए (देखें [CLAUDE.md रेफरेंस](/docs/claude-code/claude-md))।
- **इसकी मासिक समीक्षा करें।** पुराने निर्देश किसी भी निर्देश से बदतर होते हैं।

## संबंधित

- पूरी हाउ-टू → [CLAUDE.md और मेमोरी फ़ाइलें](/docs/claude-code/claude-md)
- अधिक स्टार्टर → [SKILL.md टेम्पलेट](/docs/templates/skills), [हुक्स और सेटिंग्स रेसिपी](/docs/templates/hooks-settings)
