...
Un CLAUDE.md lungo, velleitario o non aggiornato *fa danni* — Claude lo segue alla lettera. Descrivi come funziona **davvero** il progetto e pota senza pietà. Dettagli nella [pagina su CLAUDE.md](/docs/claude-code/claude-md).
:::
...
- **Usa gli `@imports`** per richiamare la documentazione esistente invece di duplicarla (vedi il [riferimento di CLAUDE.md](/docs/claude-code/claude-md)).
- **Rivedilo ogni mese.** Istruzioni obsolete sono peggio di nessuna istruzione.

## Correlati

- La guida completa → [CLAUDE.md e file di memoria](/docs/claude-code/claude-md)
- Altri modelli di partenza → [Modelli SKILL.md](/docs/templates/skills), [ricette di hook e settings](/docs/templates/hooks-settings)
