...
Un CLAUDE.md long, aspirationnel ou obsolète *nuit* — Claude le suit à la lettre. Décrivez comment le projet fonctionne **réellement**, et élaguez sans pitié. Détails sur la [page CLAUDE.md](/docs/claude-code/claude-md).
:::
...
- **Utilisez les `@imports`** pour intégrer la documentation existante au lieu de la dupliquer (voir la [référence CLAUDE.md](/docs/claude-code/claude-md)).
- **Révisez-le chaque mois.** Des instructions périmées sont pires que pas d'instructions du tout.

## Voir aussi

- Le guide complet → [CLAUDE.md et fichiers de mémoire](/docs/claude-code/claude-md)
- Plus de modèles de départ → [Modèles SKILL.md](/docs/templates/skills), [recettes de hooks et settings](/docs/templates/hooks-settings)
