...
Pull in existing docs instead of duplicating them — e.g. reference your style guide with an `@path/to/file` import so there's one source of truth. See the [official memory docs](https://docs.anthropic.com/en/docs/claude-code/memory) for the exact syntax.
